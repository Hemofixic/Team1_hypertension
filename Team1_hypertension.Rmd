...
В данном исследовании была проанализирована зависимость тяжести гипертензии от 3х факторов - пола, возраста и происхождения (деревни).

Статистически значимая ассоциация между степенью заболевания и полом/происхождением пациентов отсутствует.

Обнаружена слабая статистически значимая корреляция между возрастом пациента и степенью гипертензии. Как один из факторов, с возрастом снижается эластичность сосудов, что ведет к росту артериального давления. Так как распределение степени тяжести в наших данных зависит от пола, то мы разделили всех пациентов на 2 подгруппы. У мужчин степень гипертензии не зависит от возраста (нет корреляции), хотя по лит.данным у мужчин до 50 лет гипертензия встречается чаще. Средний возраст мужчин в нашей выборке - 53 года, что возможно смещает результаты теста.

У женщин обнаружена положительная корреляция между возрастом и степенью заболевания, что возможно связано с уровнем эстрогенов у женщин до наступления менопаузы и после.

Также обнаружена статистически значимая взаимосвязь между степень заболевания и происхождением для женщин в 2х деревнях.
